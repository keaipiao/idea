...
| 模块 | 状态 | 文档 |
|---|---|---|
| **PR-1** 后端脚手架 + DB + REST API + 开发期 JWT | ✅ 2026-05-28 v0.1.0 | [docs/01-想法记录MVP/PR-1/](docs/01-想法记录MVP/PR-1/) |
| **PR-2** 小程序前端 | ⏸ 待启动 | [PR-2/](docs/01-想法记录MVP/PR-2/) |
| **PR-3** 网页端前端 | ⏸ 待启动 | [PR-3/](docs/01-想法记录MVP/PR-3/) |
...
├── docker-compose.dev.yml        本地开发环境(PostgreSQL 16)
├── .env.example                  环境变量模板
└── docs/
    ├── _UI设计规范.md            项目级 UI 通用规范
    ├── _开发流程SOP.md           开发流程姊妹文档
    └── 01-想法记录MVP/           feature 级设计 + PR 子目录
```
